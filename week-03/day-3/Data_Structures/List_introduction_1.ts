...
names.map((name: string, index: number) => console.log(`${index + 1}. ${name}`)); //automatikusan 0-ról indul, ezért +1-et az indexhez hozzá kell adni
...
// names.reverse() Ebben az esetben a tömben felcseréli az elemeket, de nem listázva írja ki
// console.log(names);
